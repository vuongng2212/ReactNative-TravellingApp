            ...
            {activeSection === 'location' && (
                <View style={styles.expandedSection}>
                    <View style={styles.optionsContainer}>
                        <TouchableOpacity onPress={() => setLocation('Anywhere')}>
                            <View style={styles.option}>
                                <Image
                                    source={{
                                        uri: 'https://photo.znews.vn/w860/Uploaded/jaroin/2017_10_02/02_Bavaria_travelandleisure_1.jpg',
                                    }}
                        ...
                        <TouchableOpacity onPress={() => setLocation('Europe')}>
                            <View style={styles.option}>
                                <Image
                                    source={{
                                        uri: 'https://media-cdn.tripadvisor.com/media/photo-c/1280x250/17/15/6d/d6/paris.jpg',
                                    }}
                                    style={styles.optionImage}
                                />
                        ...
                        <TouchableOpacity onPress={() => setLocation('Asia')}>
                            <View style={styles.option}>
                                <Image
                                    source={{
                                        uri: 'https://cdnphoto.dantri.com.vn/R5anasgck8LnSKyaL43dDfjt6DY=/thumb_w/960/2020/07/06/thanhbinh-67-docx-1594030048659.jpeg',
                                    }}
                                    style={styles.optionImage}
                                />
...
const styles = StyleSheet.create({
    ...
    buttonsContainer: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 20, position: 'absolute', bottom: 16, left: 16, right: 16 },
